...
js/i18n.js           All BG/EN translations (~400 keys)
...
- All new text must have `data-i18n` or `data-i18n-html` attribute pointing to a key in `js/i18n.js`. Add both BG and EN entries.
